            ...
            <div className="col-11 col-md-5 col-lg-4 m-lr-auto">
              <div className="how-bor1 ">
                <div className="hov-img0">
                  <img
                    src="https://github.com/projectReact21/coza_store/blob/main/src/resoures/img/about-01.jpg?raw=true"
                    alt="IMG"
                  />
                </div>
              </div>
          ...
          <div className="row">
            ...
            <div className="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
              <div className="how-bor2">
                <div className="hov-img0">
                  <img
                    src="https://github.com/projectReact21/coza_store/blob/main/src/resoures/img/about-02.jpg?raw=true"
                    alt="IMG"
                  />
                </div>
              </div>
