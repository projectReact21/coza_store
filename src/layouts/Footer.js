              ...
              <ListGroup className="border-0  ">
                ...
                <ListGroup.Item>
                  <Row>
                    <Col sm={3} md={2}>
                      <i
                        class="fa fa-facebook-f cl-primary fs-3 hover_translate"
                        aria-hidden="true"
                      ></i>
                    </Col>
                    <Col sm={3} md={2}>
                      <i
                        class="fa fa-instagram cl-primary fs-3 hover_translate"
                        aria-hidden="true"
                      ></i>
                    </Col>
                    <Col sm={3} md={2}>
                      <i
                        class="fa fa-pinterest-p cl-primary cl-primary fs-3 hover_translate"
                        aria-hidden="true"
                      ></i>
                    </Col>
                  </Row>
